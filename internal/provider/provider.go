...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-nsx/internal/eda/utils"
...
var _ provider.Provider = (*nsxProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &nsxProvider{version: ver}
	}
}
...
func (p *nsxProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *nsxProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *nsxProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "nsx-v1"
	resp.Version = p.version
}

func (p *nsxProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewNsxPluginInstanceDataSource,
		NewNsxPluginInstanceListDataSource,
		NewResourceListDataSource,
	}
}

func (p *nsxProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewNsxPluginInstanceResource,
	}
}
